...
interface SettingsDocumentData {
   ...
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: settings.git_link
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  git_link: prismic.LinkField;
...
export interface ContentIndexSliceDefaultPrimary {
   ...
   */
  content_type: prismic.SelectField<"Certification" | "Projects">;
 ...
 */
export interface ExperiencceSliceDefaultPrimary {
  /**
   * Heading field in *Experience → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experiencce.primary.heading
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  heading: prismic.KeyTextField;
}
 ...
 */
export interface ExperiencceSliceDefaultItem {
  /**
   * Title field in *Experience → Items*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experiencce.items[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experiencce.items[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experiencce.items[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
   ...
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experiencce.items[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
 ...
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExperiencceSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<ExperiencceSliceDefaultPrimary>,
  Simplify<ExperiencceSliceDefaultItem>
>;

/**
 * Slice variation for *Experience*
 */
type ExperiencceSliceVariation = ExperiencceSliceDefault;

/**
 * Experience Shared Slice
 *
 * - **API ID**: `experiencce`
 * - **Description**: Experiencce
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type ExperiencceSlice = prismic.SharedSlice<
  "experiencce",
  ExperiencceSliceVariation
>;
...
export interface HeroSliceDefaultPrimary {
  /**
   * Jill  field in *Hero → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.jill
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  jill: prismic.KeyTextField;

  /**
   * Shah field in *Hero → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.primary.shah
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  shah: prismic.KeyTextField;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      ExperiencceSlice,
      ExperiencceSliceDefaultPrimary,
      ExperiencceSliceDefaultItem,
      ExperiencceSliceVariation,
      ExperiencceSliceDefault,
      HeroSlice,
